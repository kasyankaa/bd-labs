...
public class Factory {
    ...
    public Factory(int id, int regionId, String address, int numberOfWorkers, String phoneNumber, Collection<Delivery> deliveriesById, Region regionByRegionId, Collection<Snack> snacksById, Collection<SnackAutomat> snackAutomatsById) {
        this.id = id;
